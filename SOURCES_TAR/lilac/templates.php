...
<?php
	...
	if($numOfHostTemplates) {
		...
		if($counter % 2) {
			...
			?>
				<td height="20" class="altLeft" onclick="checkLine('line<?php echo $counter?>','check<?php echo $counter?>');">&nbsp;<a href="host_template.php?id=<?php echo $hostTemplateList[$counter]->getId();?>"><?php echo rgm_esc($hostTemplateList[$counter]->getName());?></a></td>
				<td height="20" class="altRight" onclick="checkLine('line<?php echo $counter?>','check<?php echo $counter?>');">&nbsp;<?php echo rgm_esc($hostTemplateList[$counter]->getDescription());?></td>
	...
	if($numOfServiceTemplates) {
		...
		if($counter % 2) {
			...
			?>
				<td height="20" class="altLeft" onclick="checkLine('Sline<?php echo $counter?>','Scheck<?php echo $counter?>');">&nbsp;<a href="service_template.php?id=<?php echo $serviceTemplateList[$counter]->getId();?>"><?php echo rgm_esc($serviceTemplateList[$counter]->getName());?></a></td>
				<td height="20" class="altRight" onclick="checkLine('Sline<?php echo $counter?>','Scheck<?php echo $counter?>');">&nbsp;<?php echo rgm_esc($serviceTemplateList[$counter]->getDescription());?></td>
