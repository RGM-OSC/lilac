        ...
        echo ' <input id="targetname" name="EoN_Association_Value" type="text"/> <input class="btn btn-primary btn-xs" type="submit" name="EoN_Association" value="Do it!">
                ...
                <script type="text/javascript">
                        function RefreshAutoComplete() {
                            ...
                            let targettype = "hosts.php?request=search&type="+$("#targettype :selected").val();
                            $("#targetname").autocomplete({source: targettype});
                        }
                        $(function() {
                            RefreshAutoComplete();
                        });
...
/**
 * @param String The string to escape, including all simple and double quotes
 */
function rgm_esc($str) {
