...
print_header("Add Dependency To " . rgm_esc($title) . " " . rgm_esc($textTitle));

print_window_header("Add Dependency To " . rgm_esc($title) . " " . rgm_esc($textTitle), "100%");
	?>
	<strong>Provide A Name for this Dependency</strong>
		...
		<br />
		<br /><a class="btn btn-default" href="<?php echo $link;?>?id=<?php echo $tempSource->getId();?>">Cancel And Return To <?php echo rgm_esc($title);?> <?php echo rgm_esc($textTitle);?></a>
		</form>
		<?php
print_window_footer();
