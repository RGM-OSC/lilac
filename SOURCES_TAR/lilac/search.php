	...
	public function renderResults() {
		...
		if(count($this->searchResults)) {
			...
			foreach( $this->searchResults as $group=>$results) {
				...
				?>
				  <td align="center" style="padding: 2px; border-bottom: 1px solid #aaaaaa;"><a href="#" class="btn btn-primary btn-xs" onClick="return checkUncheckAll('EoN_Actions_Checks_<?php echo $OBJECTS[$group]?>');">ALL</a></td>
				</tr>
				<?php
				$count = 0;
