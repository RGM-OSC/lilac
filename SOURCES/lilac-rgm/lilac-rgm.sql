...
CREATE TABLE `export_job` (
  ...
  `cmd` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='Export Job Information';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `export_job` VALUES (1,'Nagios Export','Generates Nagios 3 compatible configuration files','O:12:\"ExportConfig\":2:{s:24:\"\0ExportConfig\0configVars\";a:5:{s:15:\"backup_existing\";b:1;s:15:\"preflight_check\";b:1;s:14:\"restart_nagios\";b:1;s:11:\"nagios_path\";s:60:\"/srv/rgm/nagios/bin/nagios -v /tmp/lilac-export-1/nagios.cfg\";s:15:\"restart_command\";s:43:\"/usr/bin/sudo /bin/systemctl restart nagios\";}s:25:\"\0ExportConfig\0engineClass\";s:18:\"NagiosExportEngine\";}','2019-03-22 19:04:23','2019-03-22 19:04:25','Complete',4,'2019-03-22 19:04:25','O:11:\"ImportStats\":2:{s:18:\"\0ImportStats\0stats\";a:0:{}s:16:\"\0ImportStats\0job\";N;}','start');
...
CREATE TABLE `label` (
  ...
  `label` text,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=286 DEFAULT CHARSET=utf8 COMMENT='Language based labels';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `nagios_broker_module` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='Event Broker Modules';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `nagios_cgi_configuration` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='CGI Configuration';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `nagios_command` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=10000 DEFAULT CHARSET=utf8 COMMENT='Nagios Command';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM AUTO_INCREMENT=10000 DEFAULT CHARSET=utf8 COMMENT='Nagios Contact';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `nagios_contact_group` (
  ...
  `alias` varchar(255) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=10000 DEFAULT CHARSET=utf8 COMMENT='Nagios Contact Group';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `nagios_contact_group` VALUES (1,'admins','RGM Administrators'),(2,'Exploitation','Groupes pour la reception des notifications avanc̩es');
...
) ENGINE=MyISAM AUTO_INCREMENT=10000 DEFAULT CHARSET=utf8 COMMENT='Member of a Nagios Contact Group';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM AUTO_INCREMENT=10000 DEFAULT CHARSET=utf8 COMMENT='Notification Command for a Nagios Contact';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM AUTO_INCREMENT=10000 DEFAULT CHARSET=utf8 COMMENT='Nagios Host';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `nagios_host` VALUES (1,'localhost','RGM Monitoring Server',NULL,NULL,'127.0.0.1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
) ENGINE=MyISAM AUTO_INCREMENT=10000 DEFAULT CHARSET=utf8 COMMENT='Contacts which belong to host templates or hosts';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `nagios_host_contact_member` VALUES (2,NULL,1,2);
...
) ENGINE=MyISAM AUTO_INCREMENT=10000 DEFAULT CHARSET=utf8 COMMENT='Contact Group for Host';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `nagios_host_contactgroup` VALUES (2,NULL,1,1);
...
) ENGINE=MyISAM AUTO_INCREMENT=10000 DEFAULT CHARSET=utf8 COMMENT='Nagios Host Template';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM AUTO_INCREMENT=10000 DEFAULT CHARSET=utf8 COMMENT='Nagios Host Template Inheritance';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `nagios_host_template_inheritance` VALUES (1,NULL,2,1,0),(2,NULL,3,1,0),(3,NULL,4,1,0),(4,1,NULL,4,0);
...
CREATE TABLE `nagios_hostgroup` (
  ...
  `action_url` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=10000 DEFAULT CHARSET=utf8 COMMENT='Nagios Hostgroup';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM AUTO_INCREMENT=10000 DEFAULT CHARSET=utf8 COMMENT='Hostgroup Membership for Host';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM AUTO_INCREMENT=10000 DEFAULT CHARSET=utf8 COMMENT='Nagios Main Configuration';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `nagios_resource` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='Nagios Resource';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM AUTO_INCREMENT=10000 DEFAULT CHARSET=utf8 COMMENT='Nagios Service';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM AUTO_INCREMENT=10000 DEFAULT CHARSET=utf8 COMMENT='Parameter for check command for service or service template';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `nagios_service_check_command_parameter` VALUES (4,NULL,3,'5'),(3,NULL,3,'10'),(5,1,NULL,'80'),(6,1,NULL,'90'),(7,2,NULL,'80'),(8,2,NULL,'90'),(9,2,NULL,'40'),(10,2,NULL,'50'),(11,3,NULL,'5'),(12,3,NULL,'10'),(13,4,NULL,'10'),(14,4,NULL,'5'),(15,5,NULL,'80'),(16,5,NULL,'90'),(17,6,NULL,'80'),(18,6,NULL,'90'),(19,7,NULL,'80'),(20,7,NULL,'20'),(21,7,NULL,'90'),(22,7,NULL,'30'),(23,8,NULL,'/'),(24,8,NULL,'90'),(25,8,NULL,'95'),(26,8,NULL,'/'),(27,8,NULL,'90'),(28,8,NULL,'95'),(29,9,NULL,'300'),(30,9,NULL,'300'),(31,11,NULL,'-v 2 -g'),(32,11,NULL,'-v 2 -g'),(33,12,NULL,'vmware-guestd'),(34,13,NULL,'ged'),(35,13,NULL,'ged'),(36,14,NULL,'rgmro'),(37,14,NULL,'XgfLlyTmMeNntE9WrTE3ToQhy7ATZmDC');
...
) ENGINE=MyISAM AUTO_INCREMENT=10000 DEFAULT CHARSET=utf8 COMMENT='Nagios  Service Group';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `nagios_service_contact_group_member` VALUES (2,NULL,1,1);
...
) ENGINE=MyISAM AUTO_INCREMENT=10000 DEFAULT CHARSET=utf8 COMMENT='Contacts which belong to service templates or services';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM AUTO_INCREMENT=10000 DEFAULT CHARSET=utf8 COMMENT='Nagios Service Template';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM AUTO_INCREMENT=10000 DEFAULT CHARSET=utf8 COMMENT='Nagios service Template Inheritance';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `nagios_timeperiod` (
  ...
  `alias` varchar(255) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=10000 DEFAULT CHARSET=utf8 COMMENT='Nagios Timeperiods';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM AUTO_INCREMENT=10000 DEFAULT CHARSET=utf8 COMMENT='Time Period Entries';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-03-22 19:11:55
